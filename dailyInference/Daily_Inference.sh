...
save_path="/workspace/data/BK/processJH_Log_Dir/logFiles"
...
goto_step()
{
    if [ $1 -eq 0 ]; then
        ...
        rfcn_results=${save_path}"/"${Task_date}"_rfcn.json"
        ...
        processing_dir=${save_path}"/"${Task_date}"_rfcn.json-labelx.json"
        ...
        ./qrsctlLoginLi.sh
        /workspace/data/softwares/qrsctl put label-x-result ${Task_date}"_data""/":${Task_date}"_rfcn.json-labelx.json-md5Processed.json-rmclass" ${Task_date}"_rfcn.json-labelx.json-md5Processed.json-rmclass"
