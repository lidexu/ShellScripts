...
cat ${rfcn_file} | /workspace/data/installedSoftwares/jq -r '.url' >${rfcn_url}
...
python ./src/parse_classname.py --inputClass guns_true --inputFile ${rfcn_file}"-md5Processed.json"
